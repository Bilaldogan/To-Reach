...
open class AnimatedTextInput: UIControl {
    ...
    fileprivate var placeholderPosition: CGPoint {
        ...
        let defaultPosition = CGPoint(
            x: placeholderAlignment != .natural ? 0 : style.leftMargin,
            y: style.placeholderSelfPosition + style.yPlaceholderPositionOffset
        )
    ...
    fileprivate func addLineViewConstraints() {
        ...
        pinLeading(toLeadingOf: lineView, constant: -style.marginPosition)
    ...
    func changeImageViewColor(imageView : UIImageView ){
